...
- Optional Lovelace card for memorial events
...
Location, elevation, and timezone default to your Home Assistant settings.
...
This integration ships a simple card for memorial events.

1. Add resource:
   - URL: `/hmemorial/hmemorial-card.js`
   - Type: `module`
2. Example card:
...
- Ensure timezone/location are correct.
